...
parser = argparse.ArgumentParser(description='SDGF for Time Series Forecasting')
...
parser.add_argument('--model', type=str, required=False, default='SDGF',
...
parser.add_argument('--decomp_level', type=int, default=3, help='')
